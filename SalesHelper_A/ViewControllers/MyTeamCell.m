...
//        self.genderLab.layer.borderWidth  = 0.5;
        ...
        self.phoneLab = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(self.headImg.frame)+10, CGRectGetMaxY(self.nameLab.frame)+17, 120, 15)];
