...
@interface LLPhotoView () <UIScrollViewDelegate>
...
//        imageView.image = image;
        ...
        /******网络返回的的图片用SD进行图片加载******/
        [imageView sd_setImageWithURL:[NSURL URLWithString:imageStr] placeholderImage:[UIImage imageNamed:@"pp_bg"] options:SDWebImageRetryFailed];
        ...
        imageView.bounds = CGRectMake(0, 0, imageSize.width, SCREEN_WIDTH/3*2);
...
- (void)setMaxMinZoomScale
{
    ...
    self.maximumZoomScale = MAX(1, maxScale); // 不能小于1
