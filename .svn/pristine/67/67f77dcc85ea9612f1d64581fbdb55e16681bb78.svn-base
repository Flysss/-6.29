...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        UITapGestureRecognizer *tap1 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(namelLabelAction)];
        self.lblName.userInteractionEnabled = YES;
        [self.lblName addGestureRecognizer:tap1];
...
- (void)namelLabelAction
{
    if (_delegate && [_delegate respondsToSelector:@selector(clikeNameLabelAction:)]) {
        [_delegate clikeNameLabelAction:self];
    }
}
