...
+ (void)addGradientLayer:(UIImageView *)imageView color:(UIColor *)color
{
    ...
    gradientLayer.colors = [NSArray arrayWithObjects:
                            (id)[UIColor colorWithHue:hue saturation:saturation brightness:0.3 alpha:0.1].CGColor,
                            (id)[UIColor colorWithHue:hue saturation:saturation brightness:0.3 alpha:0.2].CGColor,
                            (id)[UIColor colorWithHue:hue saturation:saturation brightness:0.3 alpha:0.6].CGColor,
